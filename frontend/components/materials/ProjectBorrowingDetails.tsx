            ...
            <div className="mb-4 p-3 bg-blue-50 rounded-lg">
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  ...
                  <div className="text-xs text-blue-700">总借用量 (张)</div>
                </div>
                <div>
                  <div className="text-xl font-bold text-blue-900">
                    {borrowingDetails.length}
                  </div>
                  <div className="text-xs text-blue-700">出借人数</div>
                </div>
                <div>
                  <div className="text-xl font-bold text-blue-900">
                  ...
                  <div className="bg-gray-50 px-3 py-2 border-b">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          <h4 className="text-sm font-medium text-gray-900">{detail.worker.name}</h4>
                          <p className="text-xs text-gray-600">{detail.worker.department}</p>
                        </div>
                      </div>
