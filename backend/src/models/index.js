...
// 队列系统模型
const CuttingQueue = require('./CuttingQueue');
const QueueAnnouncement = require('./QueueAnnouncement');
const PublicQueueToken = require('./PublicQueueToken');
...
// QueueAnnouncement 关联
QueueAnnouncement.belongsTo(User, {
  foreignKey: 'createdBy',
  as: 'creator'
});

User.hasMany(QueueAnnouncement, {
  foreignKey: 'createdBy',
